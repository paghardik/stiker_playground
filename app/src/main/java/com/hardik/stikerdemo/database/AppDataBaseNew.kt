...
import com.hardik.stikerdemo.appDefault.STICKERNEW_DATA_BASE_NAME
import com.hardik.stikerdemo.workers.DatabaseWorkerNew
    ...
    companion object {
        ...
        fun init(context: Context): AppDataBaseNew {
            ...
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: buildNewDatabase(context.applicationContext).also { INSTANCE = it }
            }
        }

        //create and pre-populate database
        private fun buildNewDatabase(context: Context): AppDataBaseNew {
